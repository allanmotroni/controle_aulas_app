      ...
      MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider(
              create: (_) => ModeloEscolaProvider(ModeloEscolaDao())),
          // ChangeNotifierProvider(create: (_) => ModeloOficinaProvider(ModeloOficinaDao())),
          // ChangeNotifierProvider(create: (_) => ModeloTurmaProvider(ModeloTurmaDao())),
